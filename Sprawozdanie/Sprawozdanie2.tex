		...
		\noindent\resizebox{\textwidth}{!}{
			\begin{tikzpicture}
				...
				\begin{axis}[%
					...
					\addplot[blue, dashed, smooth] table[x=InputSize,y=Time,meta=Algorithm,col sep=comma] {results/czas_szukania_bst.csv};
					\addplot[red, dotted, smooth] table[x=InputSize,y=Time,meta=Algorithm,col sep=comma] {results/czas_szukania_avl.csv};
					\legend{BST, AVL}
				\end{axis}
				\begin{axis}[%
